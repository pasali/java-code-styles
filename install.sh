#!/bin/bash
# Installs Clovify's IntelliJ configs into your user configs.

echo "Installing Clovify code style configs..."
...
echo "Done."
echo ""
echo "Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'Clovify'."
